...
const FishOrderController_1 = require("./controllers/order/FishOrderController");
...
router.put('/order/finish', isAuthenticated_1.isAuthenticated, new FishOrderController_1.FishOrderController().handle);
